...
const eventCardStyle = (isActive: boolean): React.CSSProperties => ({
  display: 'flex',
  ...
  borderRadius: '15px',
  border: isActive ? '1px solid #eee' : '1px solid #ddd',
  boxShadow: '0 2px 8px rgba(0,0,0,0.02)',
  opacity: isActive ? 1 : 0.8,
  transition: 'all 0.2s',
});

const statusBadge = (isActive: boolean): React.CSSProperties => ({
  backgroundColor: isActive ? '#28a745' : '#ff4d4f',
  color: '#fff',
  fontSize: '0.7rem',
  fontWeight: 'bold',
  padding: '3px 8px',
...
const actionBtnStyle = (isActive: boolean): React.CSSProperties => ({
  backgroundColor: isActive ? '#f8f9fa' : '#28a745',
